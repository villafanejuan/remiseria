...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'crear') {
        ...
        $stmt = $pdo->prepare('INSERT INTO remiseros (nombre, username, password, telefono, rol) VALUES (?, ?, ?, ?, "remisero")');
        $stmt->execute([$_POST['nombre'], $_POST['username'], $password, $_POST['telefono']]);
...
$remiseros = $pdo->query('SELECT * FROM remiseros WHERE rol = "remisero" ORDER BY nombre')->fetchAll();
?>
<!DOCTYPE html>
<html lang="es">
<head>
